...
def generate_schedule():
    ...
    schedule = {
        ...
        "vips":          {"node": "node-a-8core", "cores": "0-1", "threads": 2},
        "radix":         {"node": "node-a-8core", "cores": "2-3", "threads": 2},
        "barnes":        {"node": "node-a-8core", "cores": "0-1", "threads": 2},
        "canneal":       {"node": "node-a-8core", "cores": "4-7", "threads": 4},
        "streamcluster": {"node": "node-a-8core", "cores": "0-7", "threads": 8},
        "freqmine":      {"node": "node-a-8core", "cores": "0-7", "threads": 8},
    }
    dependencies = {
        "streamcluster": "vips",
        "freqmine":      "radix",
